 ...
 */
object NQueensJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensJumiActorBenchmark)
  }

  private final class NQueensJumiActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends JumiActor[AnyRef] {
