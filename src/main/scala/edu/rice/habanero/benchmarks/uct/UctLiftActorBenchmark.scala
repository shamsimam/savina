 ...
 */
object UctLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new UctLiftActorBenchmark)
  }

  private final class UctLiftActorBenchmark extends Benchmark {
   ...
   * @author <a href="http://shams.web.rice.edu/">Shams Imam</a> (shams@rice.edu)
   */
  protected class RootActor extends LiftActor[AnyRef] {

    private final val ran: Random = new Random(2)
    private var height: Int = 1
    private var size: Int = 1
    private final val children = new Array[LiftActor[AnyRef]](UctConfig.BINOMIAL_PARAM)
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        ...
        case booleanMessage: UctConfig.ShouldGenerateChildrenMessage =>
          val sender: LiftActor[AnyRef] = booleanMessage.sender.asInstanceOf[LiftActor[AnyRef]]
     ...
     */
    def checkGenerateChildrenRequest(childName: LiftActor[AnyRef], childHeight: Int) {
  ...
  protected object NodeActor {
    def createNodeActor(parent: LiftActor[AnyRef], root: LiftActor[AnyRef], height: Int, id: Int, comp: Int, urgent: Boolean): NodeActor = {
  ...
  protected class NodeActor(myParent: LiftActor[AnyRef], myRoot: LiftActor[AnyRef], myHeight: Int, myId: Int, myCompSize: Int, isUrgent: Boolean) extends LiftActor[AnyRef] {
