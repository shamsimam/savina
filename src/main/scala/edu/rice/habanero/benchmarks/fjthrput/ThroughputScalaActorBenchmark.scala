 ...
 */
object ThroughputScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ThroughputScalaActorBenchmark)
  }

  private final class ThroughputScalaActorBenchmark extends Benchmark {
  ...
  private class ThroughputActor(totalMessages: Int) extends ScalaActor[AnyRef] {
