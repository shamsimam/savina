 ...
 */
object DictionaryLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new DictionaryLiftActorBenchmark)
  }

  private final class DictionaryLiftActorBenchmark extends Benchmark {
  ...
  private class Worker(master: Master, dictionary: Dictionary, id: Int, numMessagesPerWorker: Int) extends LiftActor[AnyRef] {
  ...
  private class Dictionary(initialState: util.Map[Integer, Integer]) extends LiftActor[AnyRef] {
