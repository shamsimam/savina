 ...
 */
object PhilosopherGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PhilosopherGparsActorBenchmark)
  }

  private final class PhilosopherGparsActorBenchmark extends Benchmark {
    ...
    def runIteration() {
      ...
      val philosophers = Array.tabulate[GparsActor[AnyRef]](PhilosopherConfig.N)(i => {
  ...
  case class HungryMessage(philosopher: GparsActor[AnyRef], philosopherId: Int)
  ...
  private class PhilosopherActor(id: Int, rounds: Int, counter: AtomicLong, arbitrator: ArbitratorActor) extends GparsActor[AnyRef] {
  ...
  private class ArbitratorActor(numForks: Int) extends GparsActor[AnyRef] {
