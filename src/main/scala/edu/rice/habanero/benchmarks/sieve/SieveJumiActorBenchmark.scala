 ...
 */
object SieveJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveJumiActorBenchmark)
  }

  private final class SieveJumiActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends JumiActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends JumiActor[AnyRef] {
