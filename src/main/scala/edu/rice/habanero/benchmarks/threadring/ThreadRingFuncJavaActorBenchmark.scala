 ...
 */
object ThreadRingFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ThreadRingFuncJavaActorBenchmark)
  }

  private final class ThreadRingFuncJavaActorBenchmark extends Benchmark {
    ...
    def runIteration() {
      ...
      val ringActors = Array.tabulate[FuncJavaActor[AnyRef]](numActorsInRing)(i => {
  ...
  private class ThreadRingActor(id: Int, numActorsInRing: Int) extends FuncJavaActor[AnyRef] {

    private var nextActor: FuncJavaActor[AnyRef] = null
    ...
    override def process(msg: AnyRef) {
      ...
      msg match {
        ...
        case dm: DataMessage =>
          ...
          nextActor = dm.data.asInstanceOf[FuncJavaActor[AnyRef]]
      }
    }
  }
