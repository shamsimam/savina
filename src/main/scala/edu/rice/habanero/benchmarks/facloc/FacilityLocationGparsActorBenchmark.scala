 ...
 */
object FacilityLocationGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FacilityLocationGparsActorBenchmark)
  }

  private final class FacilityLocationGparsActorBenchmark extends Benchmark {
  ...
  private case class CustomerMsg(producer: GparsActor[AnyRef], point: Point) extends Msg
  ...
  private class ProducerActor(consumer: GparsActor[AnyRef]) extends GparsActor[AnyRef] {
  ...
  private class QuadrantActor(parent: QuadrantActor,
                              ...
                              initCustomers: java.util.List[Point]) extends GparsActor[AnyRef] {
