 ...
 */
object FilterBankScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FilterBankScalaActorBenchmark)
  }

  private final class FilterBankScalaActorBenchmark extends Benchmark {
  ...
  private class ProducerActor(numSimulations: Int) extends ScalaActor[FilterBankConfig.Message] {
    ...
    override def process(theMsg: FilterBankConfig.Message) {
      theMsg match {
        case message: FilterBankConfig.NextMessage =>
          val source = message.source.asInstanceOf[ScalaActor[FilterBankConfig.Message]]
  ...
  private abstract class FilterBankActor(nextActor: ScalaActor[FilterBankConfig.Message]) extends ScalaActor[FilterBankConfig.Message] {
  ...
  private class SourceActor(producer: ScalaActor[FilterBankConfig.Message], nextActor: ScalaActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SinkActor(printRate: Int) extends ScalaActor[FilterBankConfig.Message] {
  ...
  private class BranchesActor(numChannels: Int, numColumns: Int, H: Array[Array[Double]], F: Array[Array[Double]], nextActor: IntegratorActor) extends ScalaActor[FilterBankConfig.Message] {
  ...
  private class BankActor(sourceId: Int, numColumns: Int, H: Array[Double], F: Array[Double], integrator: IntegratorActor) extends ScalaActor[FilterBankConfig.Message] {
  ...
  private class FirFilterActor(sourceId: String, peekLength: Int, coefficients: Array[Double], nextActor: ScalaActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SampleFilterActor(sampleRate: Int, nextActor: ScalaActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class IntegratorActor(numChannels: Int, nextActor: ScalaActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class CombineActor(nextActor: ScalaActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
