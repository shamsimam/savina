 ...
 */
object FilterBankHabaneroUnorderedSelectorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FilterBankHabaneroUnorderedSelectorBenchmark)
  }

  private final class FilterBankHabaneroUnorderedSelectorBenchmark extends Benchmark {
    ...
    override def process(theMsg: FilterBankConfig.Message) {
      theMsg match {
        case message: FilterBankConfig.SourcedValueMessage =>
          ...
          curChannelIndex = message.sourceId
