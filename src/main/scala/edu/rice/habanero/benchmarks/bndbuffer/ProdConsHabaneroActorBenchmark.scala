 ...
 */
object ProdConsHabaneroActorBenchmark {
  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ProdConsHabaneroActorBenchmark)
  }

  private final class ProdConsHabaneroActorBenchmark extends Benchmark {
    ...
    private class ManagerActor(bufferSize: Int, numProducers: Int, numConsumers: Int, numItemsPerProducer: Int) extends HabaneroActor[AnyRef] {
