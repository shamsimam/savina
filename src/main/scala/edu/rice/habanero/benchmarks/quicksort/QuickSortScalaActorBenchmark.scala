 ...
 */
object QuickSortScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortScalaActorBenchmark)
  }

  private final class QuickSortScalaActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends ScalaActor[AnyRef] {
