 ...
 */
object SortedListJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SortedListJumiActorBenchmark)
  }

  private final class SortedListJumiActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, numMessagesPerWorker: Int) extends JumiActor[AnyRef] {

    private final val workers = new Array[JumiActor[AnyRef]](numWorkers)
  ...
  private class Worker(master: Master, sortedList: SortedList, id: Int, numMessagesPerWorker: Int) extends JumiActor[AnyRef] {
  ...
  private class SortedList extends JumiActor[AnyRef] {
    ...
    override def process(msg: AnyRef) {
      msg match {
        case writeMessage: SortedListConfig.WriteMessage =>
          ...
          dataList.add(value)
          val sender = writeMessage.sender.asInstanceOf[JumiActor[AnyRef]]
        ...
        case containsMessage: SortedListConfig.ContainsMessage =>
          ...
          val sender = containsMessage.sender.asInstanceOf[JumiActor[AnyRef]]
        ...
        case readMessage: SortedListConfig.SizeMessage =>
          ...
          val sender = readMessage.sender.asInstanceOf[JumiActor[AnyRef]]
          sender.send(new SortedListConfig.ResultMessage(this, value))
