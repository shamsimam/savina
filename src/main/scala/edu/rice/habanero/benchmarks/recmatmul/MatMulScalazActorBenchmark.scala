 ...
 */
object MatMulScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulScalazActorBenchmark)
  }

  private final class MatMulScalazActorBenchmark extends Benchmark {
