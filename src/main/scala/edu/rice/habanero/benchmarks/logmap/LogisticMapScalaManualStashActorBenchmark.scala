 ...
 */
object LogisticMapScalaManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapScalaManualStashActorBenchmark)
  }

  private final class LogisticMapScalaManualStashActorBenchmark extends Benchmark {
