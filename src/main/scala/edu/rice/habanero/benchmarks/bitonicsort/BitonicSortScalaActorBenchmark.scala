 ...
 */
object BitonicSortScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new BitonicSortScalaActorBenchmark)
  }

  private final class BitonicSortScalaActorBenchmark extends Benchmark {
  ...
  private class ValueDataAdapterActor(orderId: Int, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
  ...
  private class DataValueAdapterActor(nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
    override def process(msg: AnyRef) {
      msg match {
        case vm: ValueMessage =>
  ...
  private class RoundRobinSplitterActor(name: String, length: Int, receivers: Array[ScalaActor[AnyRef]]) extends ScalaActor[AnyRef] {
  ...
  private class RoundRobinJoinerActor(name: String, length: Int, numJoiners: Int, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
   ...
   */
  private class CompareExchangeActor(orderId: Int, sortDirection: Boolean, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
   ...
   */
  private class PartitionBitonicSequenceActor(orderId: Int, length: Int, sortDir: Boolean, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
    ...
    val workerActors = Array.tabulate[ScalaActor[AnyRef]](halfLength)(i => {
   ...
   */
  private class StepOfMergeActor(orderId: Int, length: Int, numSeqPartitions: Int, directionCounter: Int, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
    ...
    val workerActors = Array.tabulate[ScalaActor[AnyRef]](numSeqPartitions)(i => {
   ...
   */
  private class StepOfLastMergeActor(length: Int, numSeqPartitions: Int, sortDirection: Boolean, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
   ...
   */
  private class MergeStageActor(P: Int, N: Int, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {

    val forwardActor = {
      var loopActor: ScalaActor[AnyRef] = nextActor
   ...
   */
  private class LastMergeStageActor(N: Int, sortDirection: Boolean, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
   ...
   */
  private class BitonicSortKernelActor(N: Int, sortDirection: Boolean, nextActor: ScalaActor[AnyRef]) extends ScalaActor[AnyRef] {
