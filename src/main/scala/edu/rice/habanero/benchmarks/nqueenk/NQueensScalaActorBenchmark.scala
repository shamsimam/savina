 ...
 */
object NQueensScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensScalaActorBenchmark)
  }

  private final class NQueensScalaActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends ScalaActor[AnyRef] {
