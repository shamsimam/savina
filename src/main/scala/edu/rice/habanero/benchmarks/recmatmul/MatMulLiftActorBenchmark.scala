 ...
 */
object MatMulLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulLiftActorBenchmark)
  }

  private final class MatMulLiftActorBenchmark extends Benchmark {
