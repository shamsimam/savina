 ...
 */
object UctScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new UctScalaActorBenchmark)
  }

  private final class UctScalaActorBenchmark extends Benchmark {
   ...
   * @author <a href="http://shams.web.rice.edu/">Shams Imam</a> (shams@rice.edu)
   */
  protected class RootActor extends ScalaActor[AnyRef] {

    private final val ran: Random = new Random(2)
    private var height: Int = 1
    private var size: Int = 1
    private final val children = new Array[ScalaActor[AnyRef]](UctConfig.BINOMIAL_PARAM)
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        ...
        case booleanMessage: UctConfig.ShouldGenerateChildrenMessage =>
          val sender: ScalaActor[AnyRef] = booleanMessage.sender.asInstanceOf[ScalaActor[AnyRef]]
     ...
     */
    def checkGenerateChildrenRequest(childName: ScalaActor[AnyRef], childHeight: Int) {
  ...
  protected object NodeActor {
    def createNodeActor(parent: ScalaActor[AnyRef], root: ScalaActor[AnyRef], height: Int, id: Int, comp: Int, urgent: Boolean): NodeActor = {
  ...
  protected class NodeActor(myParent: ScalaActor[AnyRef], myRoot: ScalaActor[AnyRef], myHeight: Int, myId: Int, myCompSize: Int, isUrgent: Boolean) extends ScalaActor[AnyRef] {
