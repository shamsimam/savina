 ...
 */
object GuidedSearchFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchFuncJavaActorBenchmark)
  }

  private final class GuidedSearchFuncJavaActorBenchmark extends Benchmark {
