 ...
 */
object LogisticMapGparsManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapGparsManualStashActorBenchmark)
  }

  private final class LogisticMapGparsManualStashActorBenchmark extends Benchmark {
  ...
  private class Master extends GparsActor[AnyRef] {
  ...
  private class SeriesWorker(id: Int, master: Master, computer: RateComputer, startTerm: Double) extends GparsActor[AnyRef] {
  ...
  private class RateComputer(rate: Double) extends GparsActor[AnyRef] {
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        case computeMessage: ComputeMessage =>
          ...
          val sender = computeMessage.sender.asInstanceOf[GparsActor[AnyRef]]
