 ...
 */
object MatMulJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulJumiActorBenchmark)
  }

  private final class MatMulJumiActorBenchmark extends Benchmark {
