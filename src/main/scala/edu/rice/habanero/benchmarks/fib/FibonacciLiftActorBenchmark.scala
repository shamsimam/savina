 ...
 */
object FibonacciLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FibonacciLiftActorBenchmark)
  }

  private final class FibonacciLiftActorBenchmark extends Benchmark {
  ...
  private class FibonacciActor(parent: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
