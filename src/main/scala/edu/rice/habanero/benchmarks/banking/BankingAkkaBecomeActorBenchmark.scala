 ...
 */
object BankingAkkaBecomeActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new BankingAkkaBecomeActorBenchmark)
  }

  private final class BankingAkkaBecomeActorBenchmark extends Benchmark {
  ...
  protected class Account(id: Int, var balance: Double) extends AkkaActor[AnyRef] with Stash {
