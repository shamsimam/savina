 ...
 */
object MatMulGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulGparsActorBenchmark)
  }

  private final class MatMulGparsActorBenchmark extends Benchmark {
