 ...
 */
object ProdConsJumiActorBenchmark {
  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ProdConsJumiActorBenchmark)
  }

  private final class ProdConsJumiActorBenchmark extends Benchmark {
    ...
    private class ManagerActor(bufferSize: Int, numProducers: Int, numConsumers: Int, numItemsPerProducer: Int) extends JumiActor[AnyRef] {
    ...
    private class ProducerActor(id: Int, manager: ManagerActor, numItemsToProduce: Int) extends JumiActor[AnyRef] {
    ...
    private class ConsumerActor(id: Int, manager: ManagerActor) extends JumiActor[AnyRef] {
