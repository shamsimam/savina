 ...
 */
object PiPrecisionScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionScalaActorBenchmark)
  }

  private final class PiPrecisionScalaActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends ScalaActor[AnyRef] {
  ...
  private class Worker(master: Master, id: Int) extends ScalaActor[AnyRef] {
