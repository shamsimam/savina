 ...
 */
object PhilosopherScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PhilosopherScalaActorBenchmark)
  }

  private final class PhilosopherScalaActorBenchmark extends Benchmark {
    ...
    def runIteration() {
      ...
      val philosophers = Array.tabulate[ScalaActor[AnyRef]](PhilosopherConfig.N)(i => {
  ...
  case class HungryMessage(philosopher: ScalaActor[AnyRef], philosopherId: Int)
  ...
  private class PhilosopherActor(id: Int, rounds: Int, counter: AtomicLong, arbitrator: ArbitratorActor) extends ScalaActor[AnyRef] {
  ...
  private class ArbitratorActor(numForks: Int) extends ScalaActor[AnyRef] {
