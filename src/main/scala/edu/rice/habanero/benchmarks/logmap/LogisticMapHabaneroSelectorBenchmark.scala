 ...
 */
object LogisticMapHabaneroSelectorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapHabaneroSelectorBenchmark)
  }

  private final class LogisticMapHabaneroSelectorBenchmark extends Benchmark {
  ...
  private class SeriesWorker(id: Int, master: Master, computer: RateComputer, startTerm: Double) extends HabaneroSelector[AnyRef](2, true) {
