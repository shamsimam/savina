 ...
 */
object FilterBankJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FilterBankJumiActorBenchmark)
  }

  private final class FilterBankJumiActorBenchmark extends Benchmark {
  ...
  private class ProducerActor(numSimulations: Int) extends JumiActor[FilterBankConfig.Message] {
    ...
    override def process(theMsg: FilterBankConfig.Message) {
      theMsg match {
        case message: FilterBankConfig.NextMessage =>
          val source = message.source.asInstanceOf[JumiActor[FilterBankConfig.Message]]
  ...
  private abstract class FilterBankActor(nextActor: JumiActor[FilterBankConfig.Message]) extends JumiActor[FilterBankConfig.Message] {
  ...
  private class SourceActor(producer: JumiActor[FilterBankConfig.Message], nextActor: JumiActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SinkActor(printRate: Int) extends JumiActor[FilterBankConfig.Message] {
  ...
  private class BranchesActor(numChannels: Int, numColumns: Int, H: Array[Array[Double]], F: Array[Array[Double]], nextActor: IntegratorActor) extends JumiActor[FilterBankConfig.Message] {
  ...
  private class BankActor(sourceId: Int, numColumns: Int, H: Array[Double], F: Array[Double], integrator: IntegratorActor) extends JumiActor[FilterBankConfig.Message] {
  ...
  private class FirFilterActor(sourceId: String, peekLength: Int, coefficients: Array[Double], nextActor: JumiActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SampleFilterActor(sampleRate: Int, nextActor: JumiActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class IntegratorActor(numChannels: Int, nextActor: JumiActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class CombineActor(nextActor: JumiActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
