 ...
 */
object FilterBankScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FilterBankScalazActorBenchmark)
  }

  private final class FilterBankScalazActorBenchmark extends Benchmark {
  ...
  private class ProducerActor(numSimulations: Int) extends ScalazActor[FilterBankConfig.Message] {
    ...
    override def process(theMsg: FilterBankConfig.Message) {
      theMsg match {
        case message: FilterBankConfig.NextMessage =>
          val source = message.source.asInstanceOf[ScalazActor[FilterBankConfig.Message]]
  ...
  private abstract class FilterBankActor(nextActor: ScalazActor[FilterBankConfig.Message]) extends ScalazActor[FilterBankConfig.Message] {
  ...
  private class SourceActor(producer: ScalazActor[FilterBankConfig.Message], nextActor: ScalazActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SinkActor(printRate: Int) extends ScalazActor[FilterBankConfig.Message] {
  ...
  private class BranchesActor(numChannels: Int, numColumns: Int, H: Array[Array[Double]], F: Array[Array[Double]], nextActor: IntegratorActor) extends ScalazActor[FilterBankConfig.Message] {
  ...
  private class BankActor(sourceId: Int, numColumns: Int, H: Array[Double], F: Array[Double], integrator: IntegratorActor) extends ScalazActor[FilterBankConfig.Message] {
  ...
  private class FirFilterActor(sourceId: String, peekLength: Int, coefficients: Array[Double], nextActor: ScalazActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SampleFilterActor(sampleRate: Int, nextActor: ScalazActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class IntegratorActor(numChannels: Int, nextActor: ScalazActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class CombineActor(nextActor: ScalazActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
