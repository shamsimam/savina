 ...
 */
object BitonicSortLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new BitonicSortLiftActorBenchmark)
  }

  private final class BitonicSortLiftActorBenchmark extends Benchmark {
  ...
  private class ValueDataAdapterActor(orderId: Int, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
  ...
  private class DataValueAdapterActor(nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
    override def process(msg: AnyRef) {
      msg match {
        case vm: ValueMessage =>
  ...
  private class RoundRobinSplitterActor(name: String, length: Int, receivers: Array[LiftActor[AnyRef]]) extends LiftActor[AnyRef] {
  ...
  private class RoundRobinJoinerActor(name: String, length: Int, numJoiners: Int, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
   ...
   */
  private class CompareExchangeActor(orderId: Int, sortDirection: Boolean, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
   ...
   */
  private class PartitionBitonicSequenceActor(orderId: Int, length: Int, sortDir: Boolean, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
    ...
    val workerActors = Array.tabulate[LiftActor[AnyRef]](halfLength)(i => {
   ...
   */
  private class StepOfMergeActor(orderId: Int, length: Int, numSeqPartitions: Int, directionCounter: Int, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
    ...
    val workerActors = Array.tabulate[LiftActor[AnyRef]](numSeqPartitions)(i => {
   ...
   */
  private class StepOfLastMergeActor(length: Int, numSeqPartitions: Int, sortDirection: Boolean, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
   ...
   */
  private class MergeStageActor(P: Int, N: Int, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {

    val forwardActor = {
      var loopActor: LiftActor[AnyRef] = nextActor
   ...
   */
  private class LastMergeStageActor(N: Int, sortDirection: Boolean, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
   ...
   */
  private class BitonicSortKernelActor(N: Int, sortDirection: Boolean, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
  ...
  private class IntSourceActor(numValues: Int, maxValue: Long, seed: Long, nextActor: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
