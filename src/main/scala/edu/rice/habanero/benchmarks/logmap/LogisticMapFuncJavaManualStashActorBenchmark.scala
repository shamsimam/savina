 ...
 */
object LogisticMapFuncJavaManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapFuncJavaManualStashActorBenchmark)
  }

  private final class LogisticMapFuncJavaManualStashActorBenchmark extends Benchmark {
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        case computeMessage: ComputeMessage =>
          ...
          val sender = computeMessage.sender.asInstanceOf[FuncJavaActor[AnyRef]]
