 ...
 */
object SieveJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveJetlangActorBenchmark)
  }

  private final class SieveJetlangActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends JetlangActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends JetlangActor[AnyRef] {
