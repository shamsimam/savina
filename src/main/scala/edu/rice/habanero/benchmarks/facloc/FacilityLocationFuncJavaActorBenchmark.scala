 ...
 */
object FacilityLocationFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FacilityLocationFuncJavaActorBenchmark)
  }

  private final class FacilityLocationFuncJavaActorBenchmark extends Benchmark {
  ...
  private case class CustomerMsg(producer: FuncJavaActor[AnyRef], point: Point) extends Msg
  ...
  private class ProducerActor(consumer: FuncJavaActor[AnyRef]) extends FuncJavaActor[AnyRef] {
  ...
  private class QuadrantActor(parent: QuadrantActor,
                              ...
                              initCustomers: java.util.List[Point]) extends FuncJavaActor[AnyRef] {
