 ...
 */
object BitonicSortHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new BitonicSortHabaneroActorBenchmark)
  }

  private final class BitonicSortHabaneroActorBenchmark extends Benchmark {
  ...
  private class ValueDataAdapterActor(orderId: Int, nextActor: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
  ...
  private class RoundRobinJoinerActor(name: String, length: Int, numJoiners: Int, nextActor: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
   ...
   */
  private class CompareExchangeActor(orderId: Int, sortDirection: Boolean, nextActor: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
   ...
   */
  private class PartitionBitonicSequenceActor(orderId: Int, length: Int, sortDir: Boolean, nextActor: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
