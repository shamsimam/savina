 ...
 */
object DictionaryGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new DictionaryGparsActorBenchmark)
  }

  private final class DictionaryGparsActorBenchmark extends Benchmark {
  ...
  private class Worker(master: Master, dictionary: Dictionary, id: Int, numMessagesPerWorker: Int) extends GparsActor[AnyRef] {
  ...
  private class Dictionary(initialState: util.Map[Integer, Integer]) extends GparsActor[AnyRef] {
