 ...
 */
object TrapezoidalJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalJumiActorBenchmark)
  }

  private final class TrapezoidalJumiActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int) extends JumiActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends JumiActor[AnyRef] {
