 ...
 */
object QuickSortScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortScalazActorBenchmark)
  }

  private final class QuickSortScalazActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends ScalazActor[AnyRef] {
