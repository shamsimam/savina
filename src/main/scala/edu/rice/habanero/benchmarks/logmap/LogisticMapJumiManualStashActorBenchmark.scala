 ...
 */
object LogisticMapJumiManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapJumiManualStashActorBenchmark)
  }

  private final class LogisticMapJumiManualStashActorBenchmark extends Benchmark {
  ...
  private class Master extends JumiActor[AnyRef] {
  ...
  private class SeriesWorker(id: Int, master: Master, computer: RateComputer, startTerm: Double) extends JumiActor[AnyRef] {
  ...
  private class RateComputer(rate: Double) extends JumiActor[AnyRef] {
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        case computeMessage: ComputeMessage =>
          ...
          val sender = computeMessage.sender.asInstanceOf[JumiActor[AnyRef]]
