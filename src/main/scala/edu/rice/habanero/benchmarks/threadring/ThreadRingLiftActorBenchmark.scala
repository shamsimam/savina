 ...
 */
object ThreadRingLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ThreadRingLiftActorBenchmark)
  }

  private final class ThreadRingLiftActorBenchmark extends Benchmark {
    ...
    def runIteration() {
      ...
      val ringActors = Array.tabulate[LiftActor[AnyRef]](numActorsInRing)(i => {
  ...
  private class ThreadRingActor(id: Int, numActorsInRing: Int) extends LiftActor[AnyRef] {

    private var nextActor: LiftActor[AnyRef] = null
    ...
    override def process(msg: AnyRef) {
      ...
      msg match {
        ...
        case dm: DataMessage =>
          ...
          nextActor = dm.data.asInstanceOf[LiftActor[AnyRef]]
      }
    }
  }
