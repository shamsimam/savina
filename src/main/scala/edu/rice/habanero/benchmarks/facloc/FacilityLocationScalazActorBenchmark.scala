 ...
 */
object FacilityLocationScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FacilityLocationScalazActorBenchmark)
  }

  private final class FacilityLocationScalazActorBenchmark extends Benchmark {
  ...
  private case class CustomerMsg(producer: ScalazActor[AnyRef], point: Point) extends Msg
  ...
  private class ProducerActor(consumer: ScalazActor[AnyRef]) extends ScalazActor[AnyRef] {
  ...
  private class QuadrantActor(parent: QuadrantActor,
                              ...
                              initCustomers: java.util.List[Point]) extends ScalazActor[AnyRef] {
