 ...
 */
object TrapezoidalGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalGparsActorBenchmark)
  }

  private final class TrapezoidalGparsActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int) extends GparsActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends GparsActor[AnyRef] {
