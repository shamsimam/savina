 ...
 */
object ProdConsScalaActorBenchmark {
  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ProdConsScalaActorBenchmark)
  }

  private final class ProdConsScalaActorBenchmark extends Benchmark {
    ...
    private class ManagerActor(bufferSize: Int, numProducers: Int, numConsumers: Int, numItemsPerProducer: Int) extends ScalaActor[AnyRef] {
    ...
    private class ProducerActor(id: Int, manager: ManagerActor, numItemsToProduce: Int) extends ScalaActor[AnyRef] {
    ...
    private class ConsumerActor(id: Int, manager: ManagerActor) extends ScalaActor[AnyRef] {
