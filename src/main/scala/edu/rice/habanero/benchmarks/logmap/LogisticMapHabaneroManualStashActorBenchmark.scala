 ...
 */
object LogisticMapHabaneroManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapHabaneroManualStashActorBenchmark)
  }

  private final class LogisticMapHabaneroManualStashActorBenchmark extends Benchmark {
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        case computeMessage: ComputeMessage =>
          ...
          val sender = computeMessage.sender.asInstanceOf[HabaneroActor[AnyRef]]
