 ...
 */
object PhilosopherLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PhilosopherLiftActorBenchmark)
  }

  private final class PhilosopherLiftActorBenchmark extends Benchmark {
    ...
    def runIteration() {
      ...
      val philosophers = Array.tabulate[LiftActor[AnyRef]](PhilosopherConfig.N)(i => {
  ...
  case class HungryMessage(philosopher: LiftActor[AnyRef], philosopherId: Int)
  ...
  private class PhilosopherActor(id: Int, rounds: Int, counter: AtomicLong, arbitrator: ArbitratorActor) extends LiftActor[AnyRef] {
  ...
  private class ArbitratorActor(numForks: Int) extends LiftActor[AnyRef] {
