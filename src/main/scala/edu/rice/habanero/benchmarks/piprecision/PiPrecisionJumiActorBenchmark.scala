 ...
 */
object PiPrecisionJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionJumiActorBenchmark)
  }

  private final class PiPrecisionJumiActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends JumiActor[AnyRef] {
  ...
  private class Worker(master: Master, id: Int) extends JumiActor[AnyRef] {
