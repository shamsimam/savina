 ...
 */
object FibonacciGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FibonacciGparsActorBenchmark)
  }

  private final class FibonacciGparsActorBenchmark extends Benchmark {
  ...
  private class FibonacciActor(parent: GparsActor[AnyRef]) extends GparsActor[AnyRef] {
