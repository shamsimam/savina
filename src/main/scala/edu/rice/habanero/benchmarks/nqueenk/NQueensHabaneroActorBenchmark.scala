 ...
 */
object NQueensHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensHabaneroActorBenchmark)
  }

  private final class NQueensHabaneroActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends HabaneroActor[AnyRef] {
