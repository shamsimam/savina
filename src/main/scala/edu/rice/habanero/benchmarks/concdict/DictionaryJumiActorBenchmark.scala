 ...
 */
object DictionaryJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new DictionaryJumiActorBenchmark)
  }

  private final class DictionaryJumiActorBenchmark extends Benchmark {
  ...
  private class Worker(master: Master, dictionary: Dictionary, id: Int, numMessagesPerWorker: Int) extends JumiActor[AnyRef] {
  ...
  private class Dictionary(initialState: util.Map[Integer, Integer]) extends JumiActor[AnyRef] {
