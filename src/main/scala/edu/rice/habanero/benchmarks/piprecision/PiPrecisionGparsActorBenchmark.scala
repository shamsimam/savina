 ...
 */
object PiPrecisionGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionGparsActorBenchmark)
  }

  private final class PiPrecisionGparsActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends GparsActor[AnyRef] {
  ...
  private class Worker(master: Master, id: Int) extends GparsActor[AnyRef] {
