 ...
 */
object SortedListLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SortedListLiftActorBenchmark)
  }

  private final class SortedListLiftActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, numMessagesPerWorker: Int) extends LiftActor[AnyRef] {

    private final val workers = new Array[LiftActor[AnyRef]](numWorkers)
  ...
  private class Worker(master: Master, sortedList: SortedList, id: Int, numMessagesPerWorker: Int) extends LiftActor[AnyRef] {
  ...
  private class SortedList extends LiftActor[AnyRef] {
    ...
    override def process(msg: AnyRef) {
      msg match {
        case writeMessage: SortedListConfig.WriteMessage =>
          ...
          dataList.add(value)
          val sender = writeMessage.sender.asInstanceOf[LiftActor[AnyRef]]
        ...
        case containsMessage: SortedListConfig.ContainsMessage =>
          ...
          val sender = containsMessage.sender.asInstanceOf[LiftActor[AnyRef]]
        ...
        case readMessage: SortedListConfig.SizeMessage =>
          ...
          val sender = readMessage.sender.asInstanceOf[LiftActor[AnyRef]]
          sender.send(new SortedListConfig.ResultMessage(this, value))
