 ...
 */
object LogisticMapJetlangManualStashActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapJetlangManualStashActorBenchmark)
  }

  private final class LogisticMapJetlangManualStashActorBenchmark extends Benchmark {
    ...
    override def process(theMsg: AnyRef) {
      theMsg match {
        case computeMessage: ComputeMessage =>
          ...
          val sender = computeMessage.sender.asInstanceOf[JetlangActor[AnyRef]]
