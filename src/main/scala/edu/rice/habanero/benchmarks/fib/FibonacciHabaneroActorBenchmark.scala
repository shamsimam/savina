 ...
 */
object FibonacciHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FibonacciHabaneroActorBenchmark)
  }

  private final class FibonacciHabaneroActorBenchmark extends Benchmark {
  ...
  private class FibonacciActor(parent: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
