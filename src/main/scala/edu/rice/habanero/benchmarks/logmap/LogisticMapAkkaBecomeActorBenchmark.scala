 ...
 */
object LogisticMapAkkaBecomeActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new LogisticMapAkkaBecomeActorBenchmark)
  }

  private final class LogisticMapAkkaBecomeActorBenchmark extends Benchmark {
  ...
  private class SeriesWorker(id: Int, master: ActorRef, computer: ActorRef, startTerm: Double) extends AkkaActor[AnyRef] with Stash {
