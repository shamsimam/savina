 ...
 */
object MatMulFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulFuncJavaActorBenchmark)
  }

  private final class MatMulFuncJavaActorBenchmark extends Benchmark {
