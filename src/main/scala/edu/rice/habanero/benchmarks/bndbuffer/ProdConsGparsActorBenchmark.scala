 ...
 */
object ProdConsGparsActorBenchmark {
  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new ProdConsGparsActorBenchmark)
  }

  private final class ProdConsGparsActorBenchmark extends Benchmark {
    ...
    private class ManagerActor(bufferSize: Int, numProducers: Int, numConsumers: Int, numItemsPerProducer: Int) extends GparsActor[AnyRef] {
    ...
    private class ProducerActor(id: Int, manager: ManagerActor, numItemsToProduce: Int) extends GparsActor[AnyRef] {
    ...
    private class ConsumerActor(id: Int, manager: ManagerActor) extends GparsActor[AnyRef] {
