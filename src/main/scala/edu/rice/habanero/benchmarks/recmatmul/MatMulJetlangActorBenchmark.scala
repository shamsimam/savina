 ...
 */
object MatMulJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new MatMulJetlangActorBenchmark)
  }

  private final class MatMulJetlangActorBenchmark extends Benchmark {
