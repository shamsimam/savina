 ...
 */
object DictionaryScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new DictionaryScalaActorBenchmark)
  }

  private final class DictionaryScalaActorBenchmark extends Benchmark {
  ...
  private class Worker(master: Master, dictionary: Dictionary, id: Int, numMessagesPerWorker: Int) extends ScalaActor[AnyRef] {
  ...
  private class Dictionary(initialState: util.Map[Integer, Integer]) extends ScalaActor[AnyRef] {
