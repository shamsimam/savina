 ...
 */
object PiPrecisionJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionJetlangActorBenchmark)
  }

  private final class PiPrecisionJetlangActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends JetlangActor[AnyRef] {
