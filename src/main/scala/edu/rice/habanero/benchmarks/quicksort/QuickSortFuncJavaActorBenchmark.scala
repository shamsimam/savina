 ...
 */
object QuickSortFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortFuncJavaActorBenchmark)
  }

  private final class QuickSortFuncJavaActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends FuncJavaActor[AnyRef] {
