 ...
 */
object SieveScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveScalazActorBenchmark)
  }

  private final class SieveScalazActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends ScalazActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends ScalazActor[AnyRef] {
