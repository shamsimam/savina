 ...
 */
object NQueensFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensFuncJavaActorBenchmark)
  }

  private final class NQueensFuncJavaActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends FuncJavaActor[AnyRef] {
