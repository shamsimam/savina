 ...
 */
object GuidedSearchLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchLiftActorBenchmark)
  }

  private final class GuidedSearchLiftActorBenchmark extends Benchmark {
