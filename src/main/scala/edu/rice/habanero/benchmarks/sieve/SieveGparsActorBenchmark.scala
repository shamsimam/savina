 ...
 */
object SieveGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveGparsActorBenchmark)
  }

  private final class SieveGparsActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends GparsActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends GparsActor[AnyRef] {
