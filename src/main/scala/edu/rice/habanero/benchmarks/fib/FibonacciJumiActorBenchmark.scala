 ...
 */
object FibonacciJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FibonacciJumiActorBenchmark)
  }

  private final class FibonacciJumiActorBenchmark extends Benchmark {
  ...
  private class FibonacciActor(parent: JumiActor[AnyRef]) extends JumiActor[AnyRef] {
