 ...
 */
object SieveFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveFuncJavaActorBenchmark)
  }

  private final class SieveFuncJavaActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends FuncJavaActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends FuncJavaActor[AnyRef] {
