 ...
 */
object QuickSortHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortHabaneroActorBenchmark)
  }

  private final class QuickSortHabaneroActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends HabaneroActor[AnyRef] {
