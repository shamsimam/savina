 ...
 */
object PiPrecisionScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionScalazActorBenchmark)
  }

  private final class PiPrecisionScalazActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends ScalazActor[AnyRef] {
