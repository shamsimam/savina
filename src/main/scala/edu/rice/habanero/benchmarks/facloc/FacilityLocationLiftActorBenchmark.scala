 ...
 */
object FacilityLocationLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FacilityLocationLiftActorBenchmark)
  }

  private final class FacilityLocationLiftActorBenchmark extends Benchmark {
  ...
  private case class CustomerMsg(producer: LiftActor[AnyRef], point: Point) extends Msg
  ...
  private class ProducerActor(consumer: LiftActor[AnyRef]) extends LiftActor[AnyRef] {
  ...
  private class QuadrantActor(parent: QuadrantActor,
                              ...
                              initCustomers: java.util.List[Point]) extends LiftActor[AnyRef] {
