 ...
 */
object GuidedSearchHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchHabaneroActorBenchmark)
  }

  private final class GuidedSearchHabaneroActorBenchmark extends Benchmark {
