 ...
 */
object GuidedSearchScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchScalaActorBenchmark)
  }

  private final class GuidedSearchScalaActorBenchmark extends Benchmark {
