 ...
 */
object FibonacciScalazActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FibonacciScalazActorBenchmark)
  }

  private final class FibonacciScalazActorBenchmark extends Benchmark {
  ...
  private class FibonacciActor(parent: ScalazActor[AnyRef]) extends ScalazActor[AnyRef] {
