 ...
 */
object QuickSortJetlangActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortJetlangActorBenchmark)
  }

  private final class QuickSortJetlangActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends JetlangActor[AnyRef] {
