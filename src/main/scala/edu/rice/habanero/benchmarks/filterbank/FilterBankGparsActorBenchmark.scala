 ...
 */
object FilterBankGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FilterBankGparsActorBenchmark)
  }

  private final class FilterBankGparsActorBenchmark extends Benchmark {
  ...
  private class ProducerActor(numSimulations: Int) extends GparsActor[FilterBankConfig.Message] {
    ...
    override def process(theMsg: FilterBankConfig.Message) {
      theMsg match {
        case message: FilterBankConfig.NextMessage =>
          val source = message.source.asInstanceOf[GparsActor[FilterBankConfig.Message]]
  ...
  private abstract class FilterBankActor(nextActor: GparsActor[FilterBankConfig.Message]) extends GparsActor[FilterBankConfig.Message] {
  ...
  private class SourceActor(producer: GparsActor[FilterBankConfig.Message], nextActor: GparsActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SinkActor(printRate: Int) extends GparsActor[FilterBankConfig.Message] {
  ...
  private class BranchesActor(numChannels: Int, numColumns: Int, H: Array[Array[Double]], F: Array[Array[Double]], nextActor: IntegratorActor) extends GparsActor[FilterBankConfig.Message] {
  ...
  private class BankActor(sourceId: Int, numColumns: Int, H: Array[Double], F: Array[Double], integrator: IntegratorActor) extends GparsActor[FilterBankConfig.Message] {
  ...
  private class FirFilterActor(sourceId: String, peekLength: Int, coefficients: Array[Double], nextActor: GparsActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class SampleFilterActor(sampleRate: Int, nextActor: GparsActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class IntegratorActor(numChannels: Int, nextActor: GparsActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
  ...
  private class CombineActor(nextActor: GparsActor[FilterBankConfig.Message]) extends FilterBankActor(nextActor) {
