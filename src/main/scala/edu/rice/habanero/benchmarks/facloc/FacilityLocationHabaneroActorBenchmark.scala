 ...
 */
object FacilityLocationHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new FacilityLocationHabaneroActorBenchmark)
  }

  private final class FacilityLocationHabaneroActorBenchmark extends Benchmark {
  ...
  private case class CustomerMsg(producer: HabaneroActor[AnyRef], point: Point) extends Msg
  ...
  private class ProducerActor(consumer: HabaneroActor[AnyRef]) extends HabaneroActor[AnyRef] {
  ...
  private class QuadrantActor(parent: QuadrantActor,
                              ...
                              initCustomers: java.util.List[Point]) extends HabaneroActor[AnyRef] {
