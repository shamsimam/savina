 ...
 */
object SieveScalaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SieveScalaActorBenchmark)
  }

  private final class SieveScalaActorBenchmark extends Benchmark {
  ...
  private class NumberProducerActor(limit: Long) extends ScalaActor[AnyRef] {
  ...
  private class PrimeFilterActor(val id: Int, val myInitialPrime: Long, numMaxLocalPrimes: Int) extends ScalaActor[AnyRef] {
