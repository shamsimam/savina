 ...
 */
object NQueensLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensLiftActorBenchmark)
  }

  private final class NQueensLiftActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends LiftActor[AnyRef] {
