...
object UctScalazActorBenchmark {
   ...
   * @author <a href="http://shams.web.rice.edu/">Shams Imam</a> (shams@rice.edu)
   */
  protected class RootActor extends ScalazActor[AnyRef] {
  ...
  protected object NodeActor {
    def createNodeActor(parent: ScalazActor[AnyRef], root: ScalazActor[AnyRef], height: Int, id: Int, comp: Int, urgent: Boolean): NodeActor = {
  ...
  protected class NodeActor(myParent: ScalazActor[AnyRef], myRoot: ScalazActor[AnyRef], myHeight: Int, myId: Int, myCompSize: Int, isUrgent: Boolean) extends ScalazActor[AnyRef] {
