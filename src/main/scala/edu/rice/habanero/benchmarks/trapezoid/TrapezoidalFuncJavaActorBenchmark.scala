 ...
 */
object TrapezoidalFuncJavaActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalFuncJavaActorBenchmark)
  }

  private final class TrapezoidalFuncJavaActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int) extends FuncJavaActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends FuncJavaActor[AnyRef] {
