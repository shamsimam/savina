 ...
 */
object TrapezoidalLiftActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalLiftActorBenchmark)
  }

  private final class TrapezoidalLiftActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int) extends LiftActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends LiftActor[AnyRef] {
