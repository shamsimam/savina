 ...
 */
object NQueensGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new NQueensGparsActorBenchmark)
  }

  private final class NQueensGparsActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, priorities: Int) extends GparsActor[AnyRef] {
