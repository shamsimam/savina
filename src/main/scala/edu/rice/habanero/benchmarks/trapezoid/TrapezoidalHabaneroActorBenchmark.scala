 ...
 */
object TrapezoidalHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new TrapezoidalHabaneroActorBenchmark)
  }

  private final class TrapezoidalHabaneroActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int) extends HabaneroActor[AnyRef] {
  ...
  private class Worker(master: Master, val id: Int) extends HabaneroActor[AnyRef] {
