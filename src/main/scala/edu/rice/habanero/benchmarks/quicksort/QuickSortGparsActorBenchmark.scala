 ...
 */
object QuickSortGparsActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new QuickSortGparsActorBenchmark)
  }

  private final class QuickSortGparsActorBenchmark extends Benchmark {
  ...
  private class QuickSortActor(parent: QuickSortActor, positionRelativeToParent: Position) extends GparsActor[AnyRef] {
