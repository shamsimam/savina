 ...
 */
object GuidedSearchJumiActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new GuidedSearchJumiActorBenchmark)
  }

  private final class GuidedSearchJumiActorBenchmark extends Benchmark {
