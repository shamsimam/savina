 ...
 */
object SortedListHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SortedListHabaneroActorBenchmark)
  }

  private final class SortedListHabaneroActorBenchmark extends Benchmark {
  ...
  private class SortedList extends HabaneroActor[AnyRef] {
