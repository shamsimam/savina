 ...
 */
object PiPrecisionHabaneroActorBenchmark {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PiPrecisionHabaneroActorBenchmark)
  }

  private final class PiPrecisionHabaneroActorBenchmark extends Benchmark {
  ...
  private class Master(numWorkers: Int, scale: Int) extends HabaneroActor[AnyRef] {
